...
bffp_year <- bffp("ensmax", "BC", "historical", "ACCESS.ESM1.5", year_td, nffd_year)
effp_year <- effp("ensmax", "BC", "historical", "ACCESS.ESM1.5", nffd_year)
ffp_year <- ffp(effp_year, bffp_year)
```

```{r}
createTimeSeries(td_year, "Temp Diff")
createTimeSeries(nffd_year, "NFFD Yearly")
createTimeSeries(bffp_year, "BFFP Yearly")
createTimeSeries(effp_year, "EFFP Yearly")
createTimeSeries(ffp_year, "FFP Yearly")
...
```{r}
createTimeSeries(pas_jan, "Preceip as snow Jan")
createTimeSeries(pas_feb, "Preceip as snow Feb")
createTimeSeries(pas_mar, "Preceip as snow Mar")
createTimeSeries(pas_apr, "Preceip as snow Apr")
createTimeSeries(pas_may, "Preceip as snow May")
createTimeSeries(pas_jun, "Preceip as snow Jun")
createTimeSeries(pas_jul, "Preceip as snow Jul")
createTimeSeries(pas_aug, "Preceip as snow Aug")
createTimeSeries(pas_sep, "Preceip as snow Sep")
createTimeSeries(pas_oct, "Preceip as snow Oct")
createTimeSeries(pas_nov, "Preceip as snow Nov")
createTimeSeries(pas_dec, "Preceip as snow Dec")
...
createTimeSeries(emt_test, "Extreme min temp")
...
#View(ext_test)
createTimeSeries(ext_test, "Extreme max temp")
```
...
createTimeSeries(rh_jan, "RH January")
createTimeSeries(rh_feb, "RH February")
createTimeSeries(rh_mar, "RH March")
createTimeSeries(rh_apr, "RH April")
createTimeSeries(rh_may, "RH May")
createTimeSeries(rh_jun, "RH June")
createTimeSeries(rh_jul, "RH July")
createTimeSeries(rh_aug, "RH August")
createTimeSeries(rh_sep, "RH September")
createTimeSeries(rh_oct, "RH October")
createTimeSeries(rh_nov, "RH November")
createTimeSeries(rh_dec, "RH December")
